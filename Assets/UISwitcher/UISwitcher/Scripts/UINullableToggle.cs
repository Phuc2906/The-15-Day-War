...
namespace UISwitcher {
    ...
    public class UINullableToggle : Selectable, IPointerClickHandler {
        ...
        protected void Set(bool? value, bool notify = true) {
        ...
        public virtual void OnChanged() => OnChanged(IntToNullableBool(m_isOnNullable));

        protected virtual void OnChanged(bool? value) {}
        ...
        public void OnPointerClick(PointerEventData eventData) {
            if (m_nullValueEnabled) MoveToNextValue();
            else MoveToBetweenTrueFalse();
        }
